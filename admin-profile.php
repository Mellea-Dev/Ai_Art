     ...
     $id=$_SESSION['ID'];     
		?>
		 <?php
                 ...
                 $row['bday'];
               ?>
		   <div class="card bg-ai m-5">
		   <h1 class="card-header">User Profile</h1>
	  
		    <div class="card-body">
		     <form class="p-5" action="admin-profile-set-in.php" method="POST" enctype="multipart/form-data">
       ...
       <div class="card bg-ai m-5">
          <form class="p-5" action="admin-profilepic-in.php" method="POST" enctype="multipart/form-data">
            <span class="img-div">
            ...
            <button class="btn-ai" name="updatepro" type="submit">Update Profile</button>
          </form>
       </div>
		  </div>
		</div> 
