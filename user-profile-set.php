...
<body>
     ...
     $id=$_SESSION['ID'];     
		?>
		 <?php
		   ...
		   <h1 class="card-header">User Profile</h1>
		    ...
		    <div class="card-body">
		     <form class="p-5" action="user-profile-set-in.php" method="POST" enctype="multipart/form-data">
       ...
       <div class="card bg-artist m-5">
          <form class="p-5" action="user-profilepic-in.php" method="POST" enctype="multipart/form-data">
            <span class="img-div">
